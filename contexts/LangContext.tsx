...
const translations = {
  en: {
    ...
    // Buyer Portal
    'buyerLogin.title': 'Buyer Login',
    'buyerLogin.subtitle': 'Buyer Portal - Access investment opportunities',
    'buyerLogin.emailLabel': 'Email Address',
    'buyerLogin.passwordLabel': 'Password',
    'buyerLogin.signIn': 'Sign In',
    'buyerLogin.signingIn': 'Signing in...',
    'buyerLogin.kycLink': 'Complete KYC to Register',
    'buyerLogin.faLoginLink': 'FA/Admin Login →',
    'buyerLogin.demoNote': 'Demo: Any email / Any password',
    
    'buyerDash.title': 'Buyer Dashboard',
    'buyerDash.welcome': 'Welcome',
    'buyerDash.logout': 'Logout',
    'buyerDash.recommendedOpp': 'Recommended Opportunities',
    'buyerDash.totalVolume': 'Total Volume',
    'buyerDash.avgDiscount': 'Average Discount',
    'buyerDash.highMatch': 'High Match Projects',
    'buyerDash.monthlyVolume': 'Monthly Volume',
    'buyerDash.searchFilter': '🔍 Search & Filter',
    'buyerDash.searchCompany': 'Search Company',
    'buyerDash.capitalRange': 'Capital Range',
    'buyerDash.currentFilter': 'Current Filter',
    'buyerDash.matchProjects': 'matched projects',
    'buyerDash.aiRecommend': '🤖 AI Recommendations',
    'buyerDash.aiRecommendDesc': 'Based on your capital and preferences, the system matches these high-potential projects',
    'buyerDash.allDeals': '📊 All Investment Opportunities',
    'buyerDash.company': 'Company',
    'buyerDash.type': 'Type',
    'buyerDash.valuation': 'Valuation',
    'buyerDash.price': 'Price',
    'buyerDash.volume': 'Volume',
    'buyerDash.discount': 'Discount',
    'buyerDash.matchScore': 'Match Score',
    'buyerDash.actions': 'Actions',
    'buyerDash.details': 'Details',
    'buyerDash.dealDetail': 'Deal Details',
    'buyerDash.minPrice': 'Min',
    'buyerDash.maxPrice': 'Max',
    'buyerDash.estimatePriceRange': '💰 Estimated Price Range',
    'buyerDash.priceEstimateNote': '* Based on current market conditions and match score, for reference only',
    'buyerDash.aiAnalysis': '🎯 AI Match Analysis',
    'buyerDash.excellent': 'Excellent',
    'buyerDash.veryGood': 'Very Good',
    'buyerDash.good': 'Good',
    'buyerDash.submitInquiry': 'Submit Inquiry',
    'buyerDash.close': 'Close',
    
    // FA Hub
    'faHub.title': 'FA Hub',
    'faHub.subtitle': 'FA Hub - Manage your buyers and deals',
    'faHub.myBuyers': 'My Buyers',
    'faHub.myDeals': 'My Deals',
    'faHub.aiMatch': '🤖 AI Match',
    'faHub.myBuyersCount': 'My Buyers',
    'faHub.myDealsCount': 'My Deals',
    'faHub.kycPending': 'KYC Pending',
    'faHub.highMatch': 'High Match',
    'faHub.buyerName': 'Name',
    'faHub.buyerType': 'Type',
    'faHub.aum': 'AUM',
    'faHub.interest': 'Interest',
    'faHub.kycStatus': 'KYC Status',
    'faHub.pofStatus': 'POF Status',
    'faHub.view': 'View',
    'faHub.schedule': '📅 Schedule',
    'faHub.dealCompany': 'Company',
    'faHub.dealType': 'Type',
    'faHub.dealValuation': 'Valuation',
    'faHub.dealPrice': 'Price',
    'faHub.dealVolume': 'Volume',
    'faHub.dealDiscount': 'Discount',
    'faHub.urgency': 'Urgency',
    'faHub.match': 'Match',
    'faHub.aiMatchResults': '🤖 AI Match Results',
    'faHub.aiMatchDesc': 'Automatically matched based on capital, preferences and urgency',
    'faHub.matches': 'matches',
    'faHub.back': 'Back',
    ...
    'intentReg.sellIntents': 'Sell Intents',
    'intentReg.newToday': 'New Today',
    'intentReg.all': 'All',
    'intentReg.buyIntent': '👤 Buy Intent Registry',
    'intentReg.sellIntent': '🏷️ Sell Intent Registry',
    'intentReg.name': 'Name',
    'intentReg.target': 'Target',
    'intentReg.investment': 'Investment',
    'intentReg.timeline': 'Timeline',
    'intentReg.status': 'Status',
    'intentReg.created': 'Created',
    'intentReg.actions': 'Actions',
    'intentReg.company': 'Company',
    'intentReg.shares': 'Shares',
    'intentReg.value': 'Value',
  },
  zh: {
    // Navigation
    'nav.home': '首页',
    ...
    // Buyer Portal
    'buyerLogin.title': '买家登录',
    'buyerLogin.subtitle': '买家门户 - 访问投资机会',
    'buyerLogin.emailLabel': '邮箱地址',
    'buyerLogin.passwordLabel': '密码',
    'buyerLogin.signIn': '登录',
    'buyerLogin.signingIn': '登录中...',
    'buyerLogin.kycLink': '完成 KYC 注册',
    'buyerLogin.faLoginLink': 'FA/管理员登录 →',
    'buyerLogin.demoNote': '演示账号：任意邮箱 / 任意密码',
    
    'buyerDash.title': '买家仪表板',
    'buyerDash.welcome': '欢迎',
    'buyerDash.logout': '退出',
    'buyerDash.recommendedOpp': '推荐机会',
    'buyerDash.totalVolume': '总交易量',
    'buyerDash.avgDiscount': '平均折扣',
    'buyerDash.highMatch': '高匹配度项目',
    'buyerDash.monthlyVolume': '月度成交',
    'buyerDash.searchFilter': '🔍 搜索与筛选',
    'buyerDash.searchCompany': '搜索公司',
    'buyerDash.capitalRange': '资金规模',
    'buyerDash.currentFilter': '当前筛选',
    'buyerDash.matchProjects': '个匹配项目',
    'buyerDash.aiRecommend': '🤖 AI 智能推荐',
    'buyerDash.aiRecommendDesc': '根据您的资金规模和投资偏好，系统自动匹配以下高潜力项目',
    'buyerDash.allDeals': '📊 所有投资机会',
    'buyerDash.company': '公司',
    'buyerDash.type': '类型',
    'buyerDash.valuation': '估值',
    'buyerDash.price': '价格',
    'buyerDash.volume': '交易量',
    'buyerDash.discount': '折扣',
    'buyerDash.matchScore': '匹配度',
    'buyerDash.actions': '操作',
    'buyerDash.details': '详情',
    'buyerDash.dealDetail': '交易详情',
    'buyerDash.minPrice': '最低',
    'buyerDash.maxPrice': '最高',
    'buyerDash.estimatePriceRange': '💰 预估成交价范围',
    'buyerDash.priceEstimateNote': '* 基于当前市场情况和匹配度计算，仅供参考',
    'buyerDash.aiAnalysis': '🎯 AI 匹配分析',
    'buyerDash.excellent': '极佳',
    'buyerDash.veryGood': '很好',
    'buyerDash.good': '不错',
    'buyerDash.submitInquiry': '提交询价',
    'buyerDash.close': '关闭',
    ...
    'faHub.myDeals': '我的交易',
    'faHub.aiMatch': '🤖 AI 匹配',
    'faHub.myBuyersCount': '我的买家',
    'faHub.myDealsCount': '我的交易',
    'faHub.kycPending': 'KYC 待审核',
    'faHub.highMatch': '高匹配度',
    'faHub.buyerName': '名称',
    'faHub.buyerType': '类型',
    'faHub.aum': 'AUM',
    'faHub.interest': '兴趣',
    'faHub.kycStatus': 'KYC 状态',
    'faHub.pofStatus': 'POF 状态',
    'faHub.view': '查看',
    'faHub.schedule': '📅 安排会议',
    'faHub.dealCompany': '公司',
    'faHub.dealType': '类型',
    'faHub.dealValuation': '估值',
    'faHub.dealPrice': '价格',
    'faHub.dealVolume': '交易量',
    'faHub.dealDiscount': '折扣',
    'faHub.urgency': '紧急度',
    'faHub.match': '匹配',
    'faHub.aiMatchResults': '🤖 AI 智能匹配结果',
    'faHub.aiMatchDesc': '基于资金规模、投资偏好和紧急度自动匹配',
    'faHub.matches': '个匹配',
    'faHub.back': '返回',
    ...
    'intentReg.newToday': 'New Today',
    'intentReg.all': 'All',
    'intentReg.buyIntent': '👤 买方意向登记',
    'intentReg.sellIntent': '🏷️ 卖方意向登记',
    'intentReg.name': 'Name',
    'intentReg.target': 'Target',
    'intentReg.investment': 'Investment',
    'intentReg.timeline': 'Timeline',
